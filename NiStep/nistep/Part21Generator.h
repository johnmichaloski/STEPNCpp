...
namespace Express
{
	extern IStepNodePtr Createpart21header_schemaClass(CString classname, CString name) ;
...
public:
	...
	CString GenerateList(EListT<IStepNodePtr > * list);
	...
	EP21HeaderPtr DefaultHeader() { return _defaultheader; }
	CString P21AsHtml(CString sFilename);

	void CompileCVarDefs(CVarDefs &vars, CErrPairs & errs, CString chain=_T(""));
	void Compile(CVarDefPtr  vardef, CErrPairs & errs, CString chain=_T(""));
	////////////////////////////////////////////////////////////////
private:
	int n;
	CVarDefs vars;
