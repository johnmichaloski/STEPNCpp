...
Eb_spline_surface::Eb_spline_surface(){
	...
	m_parents.push_back(_T("Erepresentation_item")) ; 
	 ...
	 m_vars.push_back(new CVarDef(this, _T("control_points_list") ,(StepNodeType) 15, (DWORD) &(this->control_points_list), _T("std::vector< EListT<Ecartesian_pointPtr> >"), 0));
...
Erational_b_spline_surface::Erational_b_spline_surface(){
	...
	m_parents.push_back(_T("Erepresentation_item")) ; 
	 ...
	 m_bAbstract=false ; 
	 m_vars.push_back(new CVarDef(this, _T("Eb_spline_surface") ,(StepNodeType) 1, (DWORD) &(this->_b_spline_surface.m_vars),_T("Baseclass")));
	 m_vars.push_back(new CVarDef(this, _T("weights_data") ,(StepNodeType) 15, (DWORD) &(this->weights_data), _T("std::vector< EListT<ERealPtr> >"), 0));
...
{
	 Classname()="Ebounding_geometry_select";
	 Parents().clear(); 
	 Supertypes().clear(); 
	 this->Type()= select_; 
	 this->ListType()= unknown_; 
...
{
	 Classname()="Ecompound_feature_select";
	 Parents().clear(); 
	 Supertypes().clear(); 
	 this->Type()= select_; 
	 this->ListType()= unknown_; 
...
{
	 Classname()="Erestricted_area_select";
	 Parents().clear(); 
	 Supertypes().clear(); 
	 this->Type()= select_; 
	 this->ListType()= unknown_; 
...
{
	 Classname()="Etoolpath_speedprofile";
	 Parents().clear(); 
	 Supertypes().clear(); 
	 this->Type()= select_; 
	 this->ListType()= unknown_; 
...
{
	 Classname()="Ecurve_with_surface_normal";
	 Parents().clear(); 
	 Supertypes().clear(); 
	 this->Type()= select_; 
	 this->ListType()= unknown_; 
...
IStepNodePtr Createstepnc_schemaClass(CString classname, CString name) 
 {
	...
	CString(_T("Eadaptive_control")),
	CString(_T("Eaddress")),
	CString(_T("Eadvanced_brep_shape_representation")),
	CString(_T("Eadvanced_face")),
	CString(_T("Eair_strategy")),
	CString(_T("Ealong_path")),
	CString(_T("Eand_expression")),
	CString(_T("Eangle_taper")),
	CString(_T("Eap_lift_path_angle")),
	CString(_T("Eap_lift_path_tangent")),
	CString(_T("Eap_retract_angle")),
	CString(_T("Eap_retract_tangent")),
	CString(_T("Eapproach_lift_path")),
	CString(_T("Eapproach_retract_strategy")),
	CString(_T("Eapproval")),
	CString(_T("Eapproval_status")),
	CString(_T("Eassignment")),
	CString(_T("Eaxis1_placement")),
	CString(_T("Eaxis2_placement_3d")),
	CString(_T("Eaxis_trajectory")),
	CString(_T("Eb_spline_curve")),
	CString(_T("Eb_spline_curve_with_knots")),
	CString(_T("Eb_spline_surface")),
	CString(_T("Eb_spline_surface_with_knots")),
	CString(_T("Eback_boring")),
	CString(_T("Ebackside_counterbore")),
	CString(_T("Ebackside_countersink")),
	CString(_T("Eball_endmill")),
	CString(_T("Ebezier_curve")),
	CString(_T("Ebezier_surface")),
	CString(_T("Ebidirectional")),
	CString(_T("Ebidirectional_contour")),
	CString(_T("Ebinary_boolean_expression")),
	CString(_T("Eblind_bottom_condition")),
	CString(_T("Eblock")),
	CString(_T("Eboolean_expression")),
	CString(_T("Eboring")),
	CString(_T("Eboring_operation")),
	CString(_T("Eboring_tool")),
	CString(_T("Eboss")),
	CString(_T("Ebottom_and_side_finish_milling")),
	CString(_T("Ebottom_and_side_milling")),
	CString(_T("Ebottom_and_side_rough_milling")),
	CString(_T("Ebounded_curve")),
	CString(_T("Ebounded_pcurve")),
	CString(_T("Ebounded_surface")),
	CString(_T("Ebullnose_endmill")),
	CString(_T("Ecalendar_date")),
	CString(_T("Ecartesian_point")),
	CString(_T("Ecatalogue_thread")),
	CString(_T("Ecenter_drill")),
	CString(_T("Ecenter_drilling")),
	CString(_T("Ecenter_milling")),
	CString(_T("Echamfer")),
	CString(_T("Echannel")),
	CString(_T("Ecircle")),
	CString(_T("Ecircular_closed_profile")),
	CString(_T("Ecircular_closed_shape_profile")),
	CString(_T("Ecircular_offset")),
	CString(_T("Ecircular_omit")),
	CString(_T("Ecircular_path")),
	CString(_T("Ecircular_pattern")),
	CString(_T("Eclosed_pocket")),
	CString(_T("Eclosed_profile")),
	CString(_T("Eclosed_shell")),
	CString(_T("Ecombined_drill_and_reamer")),
	CString(_T("Ecombined_drill_and_tap")),
	CString(_T("Ecomparison_equal")),
	CString(_T("Ecomparison_expression")),
	CString(_T("Ecomparison_greater")),
	CString(_T("Ecomparison_greater_equal")),
	CString(_T("Ecomparison_less")),
	CString(_T("Ecomparison_less_equal")),
	CString(_T("Ecomparison_not_equal")),
	CString(_T("Ecomplete_circular_path")),
	CString(_T("Ecomposite_curve")),
	CString(_T("Ecomposite_curve_segment")),
	CString(_T("Ecompound_feature")),
	CString(_T("Econic")),
	CString(_T("Econical_hole_bottom")),
	CString(_T("Econnect_direct")),
	CString(_T("Econnect_secplane")),
	CString(_T("Econnected_face_set")),
	CString(_T("Econnector")),
	CString(_T("Econtour_bidirectional")),
	CString(_T("Econtour_parallel")),
	CString(_T("Econtour_spiral")),
	CString(_T("Ecoordinated_universal_time_offset")),
	CString(_T("Ecounter_sinking")),
	CString(_T("Ecounterbore")),
	CString(_T("Ecounterbore_hole")),
	CString(_T("Ecountersink")),
	CString(_T("Ecountersunk_hole")),
	CString(_T("Ecurve")),
	CString(_T("Ecurve_with_normal_vector")),
	CString(_T("Ecutter_contact_trajectory")),
	CString(_T("Ecutter_location_trajectory")),
	CString(_T("Ecutting_component")),
	CString(_T("Ecutting_edge_technological_data")),
	CString(_T("Ecutting_tool")),
	CString(_T("Edate")),
	CString(_T("Edate_and_time")),
	CString(_T("Edefined_thread")),
	CString(_T("Edefinitional_representation")),
	CString(_T("Edescriptive_parameter")),
	CString(_T("Ediameter_taper")),
	CString(_T("Edirection")),
	CString(_T("Edisplay_message")),
	CString(_T("Edovetail_mill")),
	CString(_T("Edrill")),
	CString(_T("Edrilling")),
	CString(_T("Edrilling_operation")),
	CString(_T("Edrilling_type_operation")),
	CString(_T("Edrilling_type_strategy")),
	CString(_T("Eedge")),
	CString(_T("Eedge_curve")),
	CString(_T("Eedge_loop")),
	CString(_T("Eedge_round")),
	CString(_T("Eelementary_surface")),
	CString(_T("Eellipse")),
	CString(_T("Eendmill")),
	CString(_T("Eexchange_pallet")),
	CString(_T("Eexecutable")),
	CString(_T("Eexplicit")),
	CString(_T("Eface")),
	CString(_T("Eface_bound")),
	CString(_T("Eface_outer_bound")),
	CString(_T("Eface_surface")),
	CString(_T("Efacemill")),
	CString(_T("Efeedstop")),
	CString(_T("Efive_axes_const_tilt_yaw")),
	CString(_T("Efive_axes_var_tilt_yaw")),
	CString(_T("Eflat_hole_bottom")),
	CString(_T("Eflat_slot_end_type")),
	CString(_T("Eflat_with_radius_hole_bottom")),
	CString(_T("Efreeform_operation")),
	CString(_T("Efreeform_strategy")),
	CString(_T("Egeneral_closed_profile")),
	CString(_T("Egeneral_outside_profile")),
	CString(_T("Egeneral_path")),
	CString(_T("Egeneral_pattern")),
	CString(_T("Egeneral_pocket_bottom_condition")),
	CString(_T("Egeneral_profile")),
	CString(_T("Egeneral_profile_floor")),
	CString(_T("Egeneral_shape_profile")),
	CString(_T("Egeometric_representation_context")),
	CString(_T("Egeometric_representation_item")),
	CString(_T("Ehole_bottom_condition")),
	CString(_T("Ehyperbola")),
	CString(_T("Eif_statement")),
	CString(_T("Ein_process_geometry")),
	CString(_T("Eindex_pallet")),
	CString(_T("Eindex_table")),
	CString(_T("Eleading_line_strategy")),
	CString(_T("Elimits_and_fits")),
	CString(_T("Eline")),
	CString(_T("Elinear_path")),
	CString(_T("Elinear_profile")),
	CString(_T("Eload_tool")),
	CString(_T("Elocal_time")),
	CString(_T("Eloop")),
	CString(_T("Eloop_slot_end_type")),
	CString(_T("Emachine_functions")),
	CString(_T("Emachined_surface")),
	CString(_T("Emachining_feature")),
	CString(_T("Emachining_operation")),
	CString(_T("Emachining_tool")),
	CString(_T("Emachining_workingstep")),
	CString(_T("Emanifold_solid_brep")),
	CString(_T("Emanufacturing_feature")),
	CString(_T("Ematerial")),
	CString(_T("Emilling_cutter")),
	CString(_T("Emilling_cutting_tool")),
	CString(_T("Emilling_machine_functions")),
	CString(_T("Emilling_machining_operation")),
	CString(_T("Emilling_technology")),
	CString(_T("Emilling_tool_body")),
	CString(_T("Emilling_tool_dimension")),
	CString(_T("Emilling_type_operation")),
	CString(_T("Emultiple_arity_boolean_expression")),
	CString(_T("Emultistep_drilling")),
	CString(_T("Enc_constant")),
	CString(_T("Enc_function")),
	CString(_T("Enc_variable")),
	CString(_T("Engon_profile")),
	CString(_T("Enon_sequential")),
	CString(_T("Enot_expression")),
	CString(_T("Enumeric_parameter")),
	CString(_T("Eoffset_vector")),
	CString(_T("Eopen_pocket")),
	CString(_T("Eopen_profile")),
	CString(_T("Eopen_shell")),
	CString(_T("Eopen_slot_end_type")),
	CString(_T("Eoperation")),
	CString(_T("Eoptional_stop")),
	CString(_T("Eor_expression")),
	CString(_T("Eordinal_date")),
	CString(_T("Eoriented_edge")),
	CString(_T("Eparabola")),
	CString(_T("Eparallel")),
	CString(_T("Eparameterised_path")),
	CString(_T("Epartial_area_definition")),
	CString(_T("Epartial_circular_path")),
	CString(_T("Epartial_circular_profile")),
	CString(_T("Epartial_circular_shape_profile")),
	CString(_T("Epath")),
	CString(_T("Epcurve")),
	CString(_T("Eperson")),
	CString(_T("Eperson_and_address")),
	CString(_T("Eplacement")),
	CString(_T("Eplanar_face")),
	CString(_T("Eplanar_pocket_bottom_condition")),
	CString(_T("Eplanar_profile_floor")),
	CString(_T("Eplane")),
	CString(_T("Eplane_cc_strategy")),
	CString(_T("Eplane_cl_strategy")),
	CString(_T("Eplane_finish_milling")),
	CString(_T("Eplane_milling")),
	CString(_T("Eplane_rough_milling")),
	CString(_T("Eplunge_helix")),
	CString(_T("Eplunge_ramp")),
	CString(_T("Eplunge_strategy")),
	CString(_T("Eplunge_toolaxis")),
	CString(_T("Eplunge_zigzag")),
	CString(_T("Eplus_minus_value")),
	CString(_T("Epocket")),
	CString(_T("Epocket_bottom_condition")),
	CString(_T("Epoint")),
	CString(_T("Epolyline")),
	CString(_T("Eprocess_model")),
	CString(_T("Eprocess_model_list")),
	CString(_T("Eprofile")),
	CString(_T("Eprofile_feature")),
	CString(_T("Eprofile_floor")),
	CString(_T("Eprogram_stop")),
	CString(_T("Eprogram_structure")),
	CString(_T("Eproject")),
	CString(_T("Eproperty_parameter")),
	CString(_T("Equasi_uniform_curve")),
	CString(_T("Equasi_uniform_surface")),
	CString(_T("Eradiused_pocket_bottom_condition")),
	CString(_T("Eradiused_slot_end_type")),
	CString(_T("Erapid_movement")),
	CString(_T("Erational_b_spline_curve")),
	CString(_T("Erational_b_spline_surface")),
	CString(_T("Ereamer")),
	CString(_T("Ereaming")),
	CString(_T("Erectangular_closed_profile")),
	CString(_T("Erectangular_closed_shape_profile")),
	CString(_T("Erectangular_offset")),
	CString(_T("Erectangular_omit")),
	CString(_T("Erectangular_open_shape_profile")),
	CString(_T("Erectangular_pattern")),
	CString(_T("Eregion")),
	CString(_T("Eregion_projection")),
	CString(_T("Eregion_surface_list")),
	CString(_T("Ereplicate_feature")),
	CString(_T("Erepresentation")),
	CString(_T("Erepresentation_context")),
	CString(_T("Erepresentation_item")),
	CString(_T("Ereturn_home")),
	CString(_T("Eright_circular_cylinder")),
	CString(_T("Eround_hole")),
	CString(_T("Erounded_end")),
	CString(_T("Erounded_u_profile")),
	CString(_T("Eselective")),
	CString(_T("Eset_mark")),
	CString(_T("Esetup")),
	CString(_T("Esetup_instruction")),
	CString(_T("Eshape_profile")),
	CString(_T("Eshape_representation")),
	CString(_T("Eside_finish_milling")),
	CString(_T("Eside_mill")),
	CString(_T("Eside_milling")),
	CString(_T("Eside_rough_milling")),
	CString(_T("Eslot")),
	CString(_T("Eslot_end_type")),
	CString(_T("Esolid_model")),
	CString(_T("Espade_drill")),
	CString(_T("Especification")),
	CString(_T("Especification_usage_constraint")),
	CString(_T("Espherical_cap")),
	CString(_T("Espherical_hole_bottom")),
	CString(_T("Espherical_surface")),
	CString(_T("Esquare_u_profile")),
	CString(_T("Estep")),
	CString(_T("Esurface")),
	CString(_T("Esurface_of_linear_extrusion")),
	CString(_T("Esurface_of_revolution")),
	CString(_T("Esurface_texture_parameter")),
	CString(_T("Eswept_surface")),
	CString(_T("Et_slot_mill")),
	CString(_T("Etap")),
	CString(_T("Etapered_drill")),
	CString(_T("Etapered_endmill")),
	CString(_T("Etapered_reamer")),
	CString(_T("Etapered_tap")),
	CString(_T("Etapping")),
	CString(_T("Etechnology")),
	CString(_T("Etee_profile")),
	CString(_T("Ethread")),
	CString(_T("Ethread_drilling")),
	CString(_T("Ethread_mill")),
	CString(_T("Ethreading_tool")),
	CString(_T("Ethree_axes")),
	CString(_T("Ethree_axes_tilted_tool")),
	CString(_T("Ethrough_bottom_condition")),
	CString(_T("Ethrough_pocket_bottom_condition")),
	CString(_T("Ethrough_profile_floor")),
	CString(_T("Etoleranced_length_measure")),
	CString(_T("Etolerances")),
	CString(_T("Etool_body")),
	CString(_T("Etool_direction")),
	CString(_T("Etool_direction_for_milling")),
	CString(_T("Etool_length_probing")),
	CString(_T("Etool_probing")),
	CString(_T("Etool_radius_probing")),
	CString(_T("Etoolpath")),
	CString(_T("Etoolpath_feature")),
	CString(_T("Etoolpath_list")),
	CString(_T("Etoolpath_speed")),
	CString(_T("Etopological_region")),
	CString(_T("Etopological_representation_item")),
	CString(_T("Etouch_probe")),
	CString(_T("Etouch_probing")),
	CString(_T("Etrajectory")),
	CString(_T("Etransition_feature")),
	CString(_T("Etravel_path")),
	CString(_T("Etrimmed_curve")),
	CString(_T("Etwist_drill")),
	CString(_T("Etwo5d_manufacturing_feature")),
	CString(_T("Etwo5d_milling_operation")),
	CString(_T("Etwo5d_milling_strategy")),
	CString(_T("Etwo_axes")),
	CString(_T("Eunary_boolean_expression")),
	CString(_T("Eunidirectional")),
	CString(_T("Euniform_curve")),
	CString(_T("Euniform_surface")),
	CString(_T("Eunload_tool")),
	CString(_T("Euser_defined_tool")),
	CString(_T("Euv_strategy")),
	CString(_T("Evector")),
	CString(_T("Evee_profile")),
	CString(_T("Evertex")),
	CString(_T("Evertex_loop")),
	CString(_T("Evertex_point")),
	CString(_T("Ewait_for_mark")),
	CString(_T("Eweek_of_year_and_day_date")),
	CString(_T("Ewhile_statement")),
	CString(_T("Ewoodruff_keyseat_mill")),
	CString(_T("Ewoodruff_slot_end_type")),
	CString(_T("Eworkingstep")),
	CString(_T("Eworkpiece")),
	CString(_T("Eworkpiece_complete_probing")),
	CString(_T("Eworkpiece_probing")),
	CString(_T("Eworkpiece_setup")),
	CString(_T("Eworkplan")),
	CString(_T("Exor_expression")));
