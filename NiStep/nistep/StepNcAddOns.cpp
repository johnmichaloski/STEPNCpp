...
{ 
	...
	m_vars.push_back(new CVarDef(this, _T("Ecurve") ,(StepNodeType) 1, (DWORD) &(this->_curve.m_vars),_T("Baseclass")));
	m_vars.push_back(new CVarDef(this, _T("start_point") ,(StepNodeType) 22, (DWORD) &(this->start_point), _T("Ecartesian_point"), 0));
	m_vars.push_back(new CVarDef(this, _T("end_point") ,(StepNodeType) 22, (DWORD) &(this->end_point), _T("Ecartesian_point"), 0));
	m_vars.push_back(new CVarDef(this, _T("center") ,(StepNodeType) 22, (DWORD) &(this->center), _T("Ecartesian_point"), 0));
