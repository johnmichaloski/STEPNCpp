...
class CStepNode :
	...
	public CComCoClass<CStepNode, &CLSID_Node>,\
...
public:
	CStepNode() {}
	virtual ~CStepNode() {}
	STDMETHOD(get_ListClassname)(BSTR* pVal){	*pVal=ExpressListClassname().AllocSysString();	return S_OK;}\
	STDMETHOD(get_Name)(BSTR* pVal){	*pVal=Name().AllocSysString();	return S_OK; }\
	STDMETHOD(get_Classname)(BSTR* pVal){	*pVal=ExpressClassname().AllocSysString();	return S_OK; }\
	STDMETHOD(get_Type)(StepNodeType* pVal){	*pVal = Type(); return S_OK; } \
	STDMETHOD(get_ListType)(StepNodeType* pVal){	*pVal = ListType(); return S_OK; }\
	STDMETHOD(GetVarString)(BSTR* pVal){	CString str = IStepNode::GetVarString();	*pVal = str.AllocSysString(); return S_OK;}\
	STDMETHOD(SetVarString)(BSTR bstr) {	IStepNode::SetVarString((LPCWSTR) bstr);	return S_OK;}\
	STDMETHOD(isSimpleType)(VARIANT_BOOL* flag) { *flag = IsSimpleType()? VARIANT_TRUE : VARIANT_FALSE; return S_OK; }\
	STDMETHOD(isListType)(VARIANT_BOOL* flag){*flag = ISymbolBase::IsListType()? VARIANT_TRUE : VARIANT_FALSE; return S_OK;}\
	STDMETHOD(isSimpleListType)( VARIANT_BOOL* flag){*flag = ISymbolBase::IsListType()? VARIANT_TRUE : VARIANT_FALSE; return S_OK;}\
	STDMETHOD(GetListVarString)(BSTR bstrDelimiter, BSTR* pVal){	CString str = IStepNode::GetVarString((LPCTSTR) _bstr_t(bstrDelimiter));	*pVal = str.AllocSysString(); return S_OK;}\
	STDMETHOD(SelectSubnode)( BSTR bstrVal, /*[out, retval]*/ INode ** ppNode) { return E_NOTIMPL; }\
	STDMETHOD(GetAttributeValue)(/*[in]*/ BSTR attrname, /*[in]*/ VARIANT vDefault, /* [out, retval]*/ VARIANT * pVal){ return E_NOTIMPL; }\
	STDMETHOD(GetAttribute)(/*[in]*/ BSTR attrname,  /*[out, retval]*/ IAttribute ** pVal){ return E_NOTIMPL; }\
	STDMETHOD(GetAttributeList)(/*[out, retval]*/ IAttributeList ** pVal) { return E_NOTIMPL; }\
	STDMETHOD(DeleteChild)(/*[in]*/ INode * pNode){ return E_NOTIMPL; }\
	STDMETHOD(GetIndex)(/*[in]*/ IAttribute * pAttr, /*[out, retval]*/ LONG * pVal){ return E_NOTIMPL; }\
	STDMETHOD(GetSize)(/*[out, retval]*/ LONG* pVal){ return E_NOTIMPL; }\
	STDMETHOD(isASimpleListType)(/*[in]*/ BSTR bstrVal, /*[out, retval]*/  VARIANT_BOOL* flag){ return E_NOTIMPL; }\
	STDMETHOD(GetListItem)(/*[in]*/ LONG nVal,  /*[out, retval]*/ INode ** ppNode){ return E_NOTIMPL; }\
	STDMETHOD(SwapListItems)(/*[in]*/ LONG index1, /*[in]*/ LONG index){ return E_NOTIMPL; }\
	STDMETHOD(SetListItem)(/*[in]*/ LONG nVal, /*[in]*/ INode * pNode){ return E_NOTIMPL; }\
	STDMETHOD(push_back)(/*[in]*/  INode * pNode,/*[in]*/  BSTR bstrName){ return E_NOTIMPL; }
};
#endif
	...
	{ 
		...
		for(int i=0; i< size(); i++)
		{
			...
			if(IsASimpleListType(ListClassname()) && this->at(i)!=NULL)  // this is what i need...
				tmp+=this->at(i)->IStepNode::GetVarString();
...
INHERITANCEDEF(EReal)
{
	...
	virtual CString GetVarString(CString fmt=_T("")) {if(fmt==_T("")) fmt=_T("%f"); return StrFormat(fmt, val); }
...
public: 
	...
	void Init()
	{
		...
		m_vars.push_back(new CVarDef(this, _T("text") ,(StepNodeType) string_, (DWORD) &(this->val), _T("string")));
		m_instancevars=m_vars;
	}
};
